...
# 📖 webpack-exercise <a name="about-project"></a>

**webpack-exercise** is a simple project for an exercise on how to use webpack.
...
```sh
  cd my-folder
  git clone https://github.com/fuadmoin/webpack-exercise.git
```
